/* No ticket -- no ticket system in use for this project (hard rule 10).
   ...
   NPSP-to-NPC v2 build attempt (2026-07-27), group 2. CARRIED FORWARD
   UNCHANGED from the PoC (sql/transformations/100).
   ...
   AccountContactRelation (030), which needs this load's real, written-back
   ...
   the target org -- see 030's own header). RecordTypeId resolved by
