/* No ticket -- no ticket system in use for this project (hard rule 10).
   ...
   NPSP-to-NPC v2 build attempt (2026-07-27), group 3.

   CARRIED FORWARD from the PoC (sql/transformations/110) -- and the
   occasion for a CORRECTION to the rebuild plan
   ...
   1. The IsDirect = true SELF-relationship (Person Account <-> its own
      ...
      instant the Person Account (020) is inserted; the sample-data build
