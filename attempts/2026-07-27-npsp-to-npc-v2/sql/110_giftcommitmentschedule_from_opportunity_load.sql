/* No ticket -- no ticket system in use for this project (hard rule 10).
   ...
   NPSP-to-NPC v2 build attempt (2026-07-27), group 11. CARRIED FORWARD
   UNCHANGED from the PoC (sql/transformations/190) -- second half of the
   Opportunity multi-Payment routing (100). TransactionPeriod='Custom'
   (matches 100's ScheduleType). TransactionAmount is the Opportunity total
