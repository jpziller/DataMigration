/* No ticket -- no ticket system in use for this project (hard rule 10).
   ...
   NPSP-to-NPC v2 build attempt (2026-07-27), group 9. Carried forward from
   the PoC (sql/transformations/170) -- see that header for the full
   rationale: ONLY 'Custom'-period RDs get an explicit insert (a
   Recurring-type GiftCommitment auto-creates its schedule; a second
   explicit insert collides live -- the 2026-07-18 architect-review fix).
   200-branch transactions read the auto-created schedule back from a live
   replicate by GiftCommitmentId, not from this table.
